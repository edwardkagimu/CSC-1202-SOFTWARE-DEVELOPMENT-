...
from . import views
from .views import WeeklogListCreateView, ApproveLogView,SubmitLogView, Workplace_SupervisorLogsView, Academic_SupervisorLogsView,DashboardView,AssignPlacementView
